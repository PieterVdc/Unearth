...
func _ready():
	...
	connect("visibility_changed", Callable(self, "_on_SlabsetWindow_visibility_changed"))
	
	oSlabsetTabs.connect("tab_changed", Callable(self, "_on_SlabsetTabs_tab_changed"))
	oTabSlabset.connect("column_shortcut_pressed", Callable(self, "_on_TabSlabset_column_shortcut_pressed"))
