...
func _ready():
	oRoundPathNearLiquid.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_path_near_liquid"))
	oRoundEarthNearPath.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_earth_near_path"))
	oRoundEarthNearLiquid.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_earth_near_liquid"))
	oRoundRockNearPath.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_rock_near_path"))
	oRoundRockNearLiquid.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_rock_near_liquid"))
	oRoundGoldNearPath.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_gold_near_path"))
	oRoundGoldNearLiquid.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_gold_near_liquid"))
	oRoundWaterNearLava.connect("toggled", Callable(self, "toggled_frail_checkbox").bind("round_water_near_lava"))
