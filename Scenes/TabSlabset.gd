...
func _ready():
	for number in 9:
		...
		shortcut.connect("pressed", Callable(self, "shortcut_pressed").bind(id))
		spinbox.min_value = 0
		spinbox.max_value = Columnset.column_count-1
		spinbox.connect("value_changed", Callable(oDkSlabsetVoxelView, "_on_Slabset3x3ColumnSpinBox_value_changed"))
		spinbox.connect("value_changed", Callable(self, "_on_Slabset3x3ColumnSpinBox_value_changed"))
	...
	regeneration_timer.connect("timeout", Callable(self, "_on_regeneration_timer_timeout"))
	add_child(flash_update_timer)
	flash_update_timer.one_shot = true
	flash_update_timer.wait_time = 0.5
	flash_update_timer.connect("timeout", Callable(self, "_on_flash_update_timer_timeout"))
	
	oSlabsetIDSpinBox.connect("value_changed", Callable(self, "_on_SlabsetIDSpinBox_value_changed"))
	oSlabsetIDSpinBox.connect("value_changed", Callable(oDkSlabsetVoxelView, "_on_SlabsetIDSpinBox_value_changed"))
	...
	slabCopyButton.connect("pressed", Callable(self, "_on_SlabCopyButton_pressed"))
	slabPasteButton.connect("pressed", Callable(self, "_on_SlabPasteButton_pressed"))
	slabRevertButton.connect("pressed", Callable(self, "_on_SlabRevertButton_pressed"))
	
	oVariationNumberSpinBox.connect("value_changed", Callable(self, "_on_VariationNumberSpinBox_value_changed"))
	oVariationNumberSpinBox.connect("value_changed", Callable(oDkSlabsetVoxelView, "_on_VariationNumberSpinBox_value_changed"))
	...
	varCopyButton.connect("pressed", Callable(self, "_on_VarCopyButton_pressed"))
	varPasteButton.connect("pressed", Callable(self, "_on_VarPasteButton_pressed"))
	varRevertButton.connect("pressed", Callable(self, "_on_VarRevertButton_pressed"))
	varRotateButton.connect("pressed", Callable(self, "_on_VarRotateButton_pressed"))
	
	oObjAddButton.connect("pressed", Callable(self, "_on_ObjAddButton_pressed"))
	oObjDeleteButton.connect("pressed", Callable(self, "_on_ObjDeleteButton_pressed"))
	oObjObjectIndexSpinBox.connect("value_changed", Callable(self, "_on_ObjObjectIndexSpinBox_value_changed"))
	oObjThingTypeSpinBox.connect("value_changed", Callable(self, "_on_ObjThingTypeSpinBox_value_changed"))
	oObjSubtypeSpinBox.connect("value_changed", Callable(self, "_on_ObjSubtypeSpinBox_value_changed"))
	oObjSubtileSpinBox.connect("value_changed", Callable(self, "_on_ObjSubtileSpinBox_value_changed"))
	oObjRelativeXSpinBox.connect("value_changed", Callable(self, "_on_ObjRelativeXSpinBox_value_changed"))
	oObjRelativeYSpinBox.connect("value_changed", Callable(self, "_on_ObjRelativeYSpinBox_value_changed"))
	oObjRelativeZSpinBox.connect("value_changed", Callable(self, "_on_ObjRelativeZSpinBox_value_changed"))
	oObjEffectRangeSpinBox.connect("value_changed", Callable(self, "_on_ObjEffectRangeSpinBox_value_changed"))
	oObjIsLightCheckBox.connect("toggled", Callable(self, "_on_ObjIsLightCheckBox_toggled"))
	
	var slabsetCopyValues = get_node("HBoxContainer/VBoxContainer/ScrollContainer/VBoxContainer/SlabsetCopyValues")
	slabsetCopyValues.connect("pressed", Callable(self, "_on_SlabsetCopyValues_pressed"))
	...
	slabsetHelpButton.connect("pressed", Callable(self, "_on_SlabsetHelpButton_pressed"))
	SlabsetRevertButton.connect("pressed", Callable(self, "_on_SlabsetRevertButton_pressed"))
	
	oConfirmRevertSlabset.connect("confirmed", Callable(self, "_on_ConfirmRevertSlabset_confirmed"))
	connect("visibility_changed", Callable(self, "_on_TabSlabset_visibility_changed"))
	
	# Connect to ConfigFileManager signals
	oConfigFileManager.connect("config_file_status_changed", Callable(self, "_on_config_status_changed"))
...
func update_column_spinboxes():
	...
	for subtile in columnSettersArray.size():
		...
		spinbox.disconnect("value_changed", Callable(self, "_on_Slabset3x3ColumnSpinBox_value_changed"))
		spinbox.disconnect("value_changed", Callable(oDkSlabsetVoxelView, "_on_Slabset3x3ColumnSpinBox_value_changed"))
...
func update_3D_sprite_visuals():
	...
	for i in listOfObjects:
		...
		if oObjIsLightCheckBox.button_pressed == true:
			tex = null
...
func update_object_fields(index):
	...
	oObjThingTypeSpinBox.disconnect("value_changed", Callable(self, "_on_ObjThingTypeSpinBox_value_changed"))
	oObjSubtypeSpinBox.disconnect("value_changed", Callable(self, "_on_ObjSubtypeSpinBox_value_changed"))
	oObjIsLightCheckBox.disconnect("toggled", Callable(self, "_on_ObjIsLightCheckBox_toggled"))
	oObjEffectRangeSpinBox.disconnect("value_changed", Callable(self, "_on_ObjEffectRangeSpinBox_value_changed"))
	oObjSubtileSpinBox.disconnect("value_changed", Callable(self, "_on_ObjSubtileSpinBox_value_changed"))
	oObjRelativeXSpinBox.disconnect("value_changed", Callable(self, "_on_ObjRelativeXSpinBox_value_changed"))
	oObjRelativeYSpinBox.disconnect("value_changed", Callable(self, "_on_ObjRelativeYSpinBox_value_changed"))
	oObjRelativeZSpinBox.disconnect("value_changed", Callable(self, "_on_ObjRelativeZSpinBox_value_changed"))
	...
	oObjIsLightCheckBox.button_pressed = bool(obj[0])
